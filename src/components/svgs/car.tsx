export default function CarSVG(){
    return(
    <div className="p-5 absolute inset-0 h-full w-full object-cover dark:brightness-[0.2] dark:grayscale flex items-center justify-center">
        <svg fill="#000000" width="200px" height="200px" viewBox="0 0 31 31">
        <g>
            <g>
